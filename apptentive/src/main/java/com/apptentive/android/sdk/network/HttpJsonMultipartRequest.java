 ...
 */
public class HttpJsonMultipartRequest extends HttpJsonRequest {
	...
	public HttpJsonMultipartRequest(String urlString, JSONObject requestObject, List<StoredFile> files) {
		super(urlString, requestObject);
